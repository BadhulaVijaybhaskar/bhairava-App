...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Astranova" },
      { property: "og:title", content: "Bhairava — Land Sales Operating System" },
      {
        property: "og:description",
        content: "Live plot inventory, customers, bookings, collections and reporting for Astranova.",
      },
      ...
      { name: "apple-mobile-web-app-title", content: "Bhairava" },
