...
export const Route = createFileRoute("/plots/editor")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Mapbox Studio-style plot layout editor with layer toggles, drawing tools and attribute editing.",
      },
      { property: "og:title", content: "Layout Mapping Editor — Bhairava" },
      { property: "og:description", content: "Studio-style editor for mapping plot layout polygons." },
    ],
  }),
