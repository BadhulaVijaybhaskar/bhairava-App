...
export const Route = createFileRoute("/reports/collections")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cashflow, collection performance against target and outstanding balance by project." },
      { property: "og:title", content: "Collections Report — Bhairava" },
      { property: "og:description", content: "Cashflow, collection performance against target and outstanding balance by project." },
    ],
  }),
