...
export const Route = createFileRoute("/settings/audit")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Review every workspace change with actor, action and before/after values." },
      { property: "og:title", content: "Audit Logs — Bhairava" },
      { property: "og:description", content: "Review every workspace change with actor, action and before/after values." },
    ],
  }),
