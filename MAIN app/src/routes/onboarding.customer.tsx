...
export const Route = createFileRoute("/onboarding/customer")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Capture a new buyer: contact, address, KYC, nominee and pipeline ownership." },
      { property: "og:title", content: "Onboard a customer — Bhairava" },
      { property: "og:description", content: "Capture a new buyer: contact, address, KYC, nominee and pipeline ownership." },
  ...
  return (
    <AppShell>
      ...
      <Wizard
        ...
        dirty={dirty}
        onDiscard={() => void navigate({ to: "/customers" })}
        aside={
