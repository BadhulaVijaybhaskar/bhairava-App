...
export const Route = createFileRoute("/reports/resale")({
  head: () => ({ meta: [{ title: "Resale Report — Bhairava" }] }),
...
function ReportPage() {
  ...
  const sourceKey = "opsResales" as const;
  ...
  return (
    <AppShell>
      <PageHeader
        eyebrow="Reports"
        title="Resale Report"
        description="Resale listings derived from operations cases."
        actions={
          <Btn variant="tonal" onClick={download} data-testid="report-resale-csv">
            Export CSV
          </Btn>
        }
      />
