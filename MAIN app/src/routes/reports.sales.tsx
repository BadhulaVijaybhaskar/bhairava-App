...
export const Route = createFileRoute("/reports/sales")({
  head: () => ({
    meta: [
      { title: "Sales Report — Bhairava" },
      { name: "description", content: "Bookings trend, project performance and pipeline metrics for the sales team." },
      { property: "og:title", content: "Sales Report — Bhairava" },
      { property: "og:description", content: "Bookings trend, project performance and pipeline metrics for the sales team." },
    ],
  }),
