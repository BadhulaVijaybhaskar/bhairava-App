...
export const Route = createFileRoute("/reports/agents")({
  head: () => ({
    meta: [
      { title: "Agent Performance — Bhairava" },
      { name: "description", content: "Leaderboard, conversion and target attainment across the sales agent roster." },
      { property: "og:title", content: "Agent Performance — Bhairava" },
      { property: "og:description", content: "Leaderboard, conversion and target attainment across the sales agent roster." },
    ],
  }),
