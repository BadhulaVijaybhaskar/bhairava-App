...
export const Route = createFileRoute("/documents")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Search, verify and manage every agreement, deed and KYC document across projects." },
      { property: "og:title", content: "Documents Centre — Bhairava" },
      { property: "og:description", content: "Search, verify and manage every agreement, deed and KYC document across projects." },
    ],
  }),
