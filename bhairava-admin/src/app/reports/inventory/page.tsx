  ...
  return (
    <AppShell>
      <PageHeader
        ...
        actions={
          <Link href="/plots/layout" className="inline-flex items-center gap-1.5 rounded-lg bg-surface-low px-3 py-2 text-sm font-medium text-muted-foreground hover:text-foreground">
