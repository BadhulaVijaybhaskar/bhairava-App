  ...
  return (
    <AppShell>
      <div className="pt-8 pb-2">
        <Link href="/payments" className="inline-flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground">
          ...
          <Panel>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <Field
                ...
                value={
                  booking ? (
                    <Link href={`/bookings/${booking.id}`} className="numeric hover:text-primary">
                      {booking.id}
                    </Link>
                  ) : (
                    "—"
