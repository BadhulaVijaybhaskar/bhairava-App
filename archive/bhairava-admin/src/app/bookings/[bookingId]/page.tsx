    ...
    return (
      <AppShell>
        <div className="flex flex-col items-center justify-center gap-3 py-32 text-center">
          ...
          <Link href="/bookings" className="pt-2 text-sm font-medium text-primary">
            Back to bookings
          </Link>
        </div>
      </AppShell>
  ...
  return (
    <AppShell>
      <div className="pt-8 pb-2">
        <Link href="/bookings" className="inline-flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground">
      ...
      <div className="grid gap-6 pb-6 lg:grid-cols-12">
        ...
        <div className="grid gap-4 lg:col-span-4">
          <Panel className="p-5">
            ...
            {customer ? (
              <Link href={`/customers/${customer.id}`} className="pt-1.5 block text-sm font-medium hover:text-primary">
                {customer.name}
              </Link>
            ) : (
